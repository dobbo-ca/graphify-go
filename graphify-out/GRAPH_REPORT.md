# Graph Report - /private/tmp/gfy-wt-graphify-go-2af.9

## Summary
- 1415 nodes · 3388 edges · 38 communities
- Extraction: 53% EXTRACTED · 46% INFERRED · 0% AMBIGUOUS

## Graph Freshness
- Built from commit: `dab1d1bc`
...
### Community 0
Cohesion: 0.03
Nodes (215): bashHasExpansion(), builder.bashCommand(), builder.bashFunc(), builder.bashItems(), builder.scriptInvocationTarget(), collectBashFuncs(), commandName(), extractBash() (+207 more)
...
### Community 2
Cohesion: 0.03
Nodes (93): TestExtractBash(), TestExtractC(), TestExtractVueComponent(), TestExtractJSONSkipsCommentKey(), TestExtractJSSkipsDegenerateName(), TestFileFromBytesMtsAsTypeScript(), TestFileFromBytesShebangBash(), File() (+85 more)

### Community 3
Cohesion: 0.04
Nodes (81): Cache, Entry, HashBytes(), HashFile(), Load(), LoadStat(), mtimeGranularity(), Save() (+73 more)

### Community 4
Cohesion: 0.05
Nodes (66): TestCollectFilesGitignore(), TestCollectFilesGraphifyignore(), errors, TestExtractCpp(), TestExtractLua(), IntrospectManifests(), manifestInfo, parseGoMod() (+58 more)

### Community 5
Cohesion: 0.05
Nodes (66): context, encoding/json, fmt, github.com/anthropics/anthropic-sdk-go, github.com/anthropics/anthropic-sdk-go/bedrock, github.com/dobbo-ca/graphify-go/internal/detect, github.com/dobbo-ca/graphify-go/internal/security, github.com/dobbo-ca/graphify-go/internal/semantic (+58 more)
...
### Community 8
Cohesion: 0.08
Nodes (54): bufio, github.com/dobbo-ca/graphify-go/internal/query, argInt(), argString(), argTokenBudget(), budgetLines(), cmdServe(), communitiesOf() (+46 more)
...
### Community 13
Cohesion: 0.09
Nodes (42): crate, IntrospectCargo(), loadTOML(), memberManifestPaths(), packageName(), TestIntrospectCargoHonorsPackageRename(), TestIntrospectCargoRenameToExternalIsNoEdge(), hasEdge() (+34 more)

### Community 14
Cohesion: 0.07
Nodes (40): cmdQuery(), net, net/url, Explanation, Graph, Graph.bfsPath(), Graph.resolve(), Link (+32 more)
