...
## Communities (42 total)

### Community 0
Cohesion: 0.03
Nodes (200): bashHasExpansion(), builder.bashCommand(), builder.bashFunc(), builder.bashItems(), builder.scriptInvocationTarget(), collectBashFuncs(), commandName(), extractBash() (+192 more)

### Community 1
Cohesion: 0.03
Nodes (90): crypto/rand, TestExtractBash(), TestExtractC(), TestExtractJSONSkipsCommentKey(), TestExtractJSSkipsDegenerateName(), File(), TestExtractAndResolve(), TestExtractJavaEnum() (+82 more)

### Community 2
Cohesion: 0.03
Nodes (101): bytes, Cache, cacheFile, Entry, HashBytes(), HashFile(), Load(), LoadStat() (+93 more)

### Community 3
Cohesion: 0.05
Nodes (100): Cycle, entityLoc(), GodNode, GodNodes(), ImportCycles(), isConceptNode(), isFileNode(), isJSONKeyNode() (+92 more)

### Community 4
Cohesion: 0.04
Nodes (95): TestExtractVueComponent(), dispatchTargets(), implementsEdge(), TestCSharpDispatchCrossLanguage(), TestCSharpDispatchSingleImplementer(), TestCSharpDispatchTwoImplementers(), extractCSharp(), TestExtractCSharp() (+87 more)

### Community 5
Cohesion: 0.06
Nodes (78): bufio, encoding/json, fmt, github.com/dobbo-ca/graphify-go/internal/query, github.com/dobbo-ca/graphify-go/internal/security, argInt(), argString(), argStrings() (+70 more)

### Community 6
Cohesion: 0.05
Nodes (68): Final verification (run before opening a PR), Reference: cloudposse `id` algorithm (what composeID reimplements), Reference: tree-sitter-hcl v1.2.0 node shapes (verified empirically), Self-review notes (author), Stage A — Foundation: null-label marker + inherits_context edge, Stage B — Single-block literal name reconstruction, Stage C — Whole-corpus context-chain reconstruction, Task A1: `isNullLabel` helper + `[null-label]` marker on module nodes (+60 more)
...
### Community 8
Cohesion: 0.07
Nodes (51): CollectFiles(), CollectFilesReport(), CollectManifests(), genericKeywordHit(), inMemoryDir(), isASCIIAlnum(), isASCIIAlpha(), IsSensitive() (+43 more)
...
### Community 12
Cohesion: 0.08
Nodes (43): crate, IntrospectCargo(), loadTOML(), memberManifestPaths(), packageName(), TestIntrospectCargoHonorsPackageRename(), TestIntrospectCargoRenameToExternalIsNoEdge(), hasEdge() (+35 more)
...
### Community 14
Cohesion: 0.09
Nodes (35): errors, handleBrokenPipe(), isBrokenPipe(), os/signal, edgeLoc(), Explain(), Explanation, Graph (+27 more)
